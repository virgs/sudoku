...
export function GameContainer() {
    ...
    return (
        <div className="container-lg p-0">
            <div className="row justify-content-center gt-3 gb-3">
                <div className="col-12 col-sm-6 col-md-7 col-lg-6 m-0">
                    <div className="d-sm-none">
                        <Header></Header>
                    </div>
                    <BoardComponent />
                </div>
                <div className="col-12 col-sm-6 col-md-5 col-lg-5 align-self-start px-3 px-xl-4 m-0 py-2">
