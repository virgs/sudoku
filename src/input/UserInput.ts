...
export const mapInputToNumber = (input: UserInput): number | undefined => {
    switch (input) {
        case UserInput.NUM_1:
            return 1
        case UserInput.NUM_2:
            return 2
        case UserInput.NUM_3:
            return 3
        case UserInput.NUM_4:
            return 4
        case UserInput.NUM_5:
            return 5
        case UserInput.NUM_6:
            return 6
        case UserInput.NUM_7:
            return 7
        case UserInput.NUM_8:
            return 8
        case UserInput.NUM_9:
            return 9
    }
